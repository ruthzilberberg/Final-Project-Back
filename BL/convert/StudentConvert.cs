...
namespace BL.Convert
{
    public class StudentConvert
    {
        public static DAL.Student ToDalStudent(DTO.StudentDTO sDto)
        {
            ...
            sDal.Class = sDto.Class;
            sDal.Grade = sDto.Grade;
            sDal.IsIncludingTeaching = sDto.IsIncludingTeaching;
            sDal.GroupNumber = sDto.GroupNumber;
            sDal.StudentStandard = sDto.StudentStandard;
            return sDal;
        }
        public static DTO.StudentDTO ToDtoStudent(DAL.Student sDal)
        {
            ...
            sDto.StudentStandard = sDal.StudentStandard;
            return sDto;
        }
